...
<form action="" method="post">
	<table>
		<tr>
			<td><input type="hidden" name="id" value="<?php echo $id; ?>" style="width:700px" /></td>
		</tr>
		<tr>
			<td>Contact No</td><td><input type="text" name="contact_no" value="<?php echo $c_no; ?>" style="width:700px" /></td>
		</tr>
		<tr>
			<td>Fax</td><td><input type="text" name="fax" value="<?php echo $fax_no; ?>" style="width:700px" /></td>
		</tr>
		<tr>
			<td>Facebook Link</td><td><input type="text" name="facebook_link" value="<?php echo $f_link; ?>" style="width:700px" /></td>
		</tr>
		<tr>
			<td>Twitter Link</td><td><input type="text" name="twitter_link" value="<?php echo $t_link; ?>" style="width:700px" /></td>
		</tr>
		<tr>
			<td>Logo URL</td><td><input type="text" name="pinterest_link" value="<?php echo $p_link; ?>" style="width:700px"/></td>
